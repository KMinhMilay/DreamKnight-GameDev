...
public class PlayerInteraction : MonoBehaviour
{
    ...
    IEnumerator BecomeInvulnerable()
    {
        ...
        Physics2D.IgnoreLayerCollision(LayerMask.NameToLayer("Player"), LayerMask.NameToLayer("Spikes"), true);
        ...
        Physics2D.IgnoreLayerCollision(LayerMask.NameToLayer("Player"), LayerMask.NameToLayer("Spikes"), false);
